...
def fetch_and_save_data():
    ...
    isotopologue_number = ISOTOPOLOGUES[molecule][isotopologue_var.get()]['id']
...
root.title("Absorption_Spectra_Voigt Download_Data")
...
ttk.Entry(root, textvariable=Temperature_var).grid(row=6, column=1, padx=10, pady=5)

ttk.Button(root, text="Fetch & Save Data", command=fetch_and_save_data).grid(row=7, column=0, columnspan=2, pady=10)
